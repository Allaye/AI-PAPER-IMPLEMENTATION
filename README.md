...
<!-- _For Octave/MatLab versionghd of this repository please check [machine-learning-octave](https://github.com/trekhleb/machine-learning-octave) project._ -->
...
served from the local project directory to avoid messing with system wide packages and their versions and make working with the project easy
